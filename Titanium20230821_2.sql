...
alter table aug18_coffee rename column c_name to c_name2;

--컬럼 추가
--alter table[테이블명]add[컬럼명][데이터타입][제약조건(생략가능)];
alter table aug18_coffee and c_taste varcjar2(20 char) not null;

--컬럼삭제
--alter table [테이블명] drop colum[컬럼명];
alter table aug18_coffee drop column c_taste;
-------------------------------------------------------------------------
--테이블 내의 내용 지우기
--truncate table[테이블명];
